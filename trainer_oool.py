...
class Trainer:
    def __init__(self, model, config_model, args, logger_main, val_loader, train_loader, result_path=None):
        self.args = args
        self.model = model
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            # 🔁 Call updated evaluate_model and assume it returns a dictionary
            ...
            self.metrics['val_loss'].append(val_metrics["avg_loss"])
    ...
    def train_epoch(self):
        ...
        for data in self.train_loader:
            ...
            batch_outputs = self._run_batch(source_augment, source_1, source_2, targets, has_labeled)
    ...
    def _run_batch(self, source, source_1, source_2, targets, has_labeled):
        ...
        loss, loss_cls, loss_rec, loss_con = compute_total_loss(
            logits, x_rec, source, has_labeled, targets,
    ...
    def plot_somethings(self):
        ...
        if self.current_epoch % 10 == 0:
            ...
            selected_classes = ["BPSK", "QPSK", "8PSK", "16APSK", "32APSK", "64APSK", "128APSK", "16QAM", "64QAM", "128QAM"]
            ...
            plot_tsne_embeddings(
                ...
                title=f"t-SNE of {self.project_title} epoch_{self.current_epoch}",
